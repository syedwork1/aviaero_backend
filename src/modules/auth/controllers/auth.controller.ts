import { Controller, Post, Body, Get, UseGuards, Req, Param, HttpCode, HttpStatus } from '@nestjs/common';
...
export class AuthController {
  ...
  @ApiResponse({ status: 409, description: 'User already exists or username taken' })
  ...
  @ApiOperation({ summary: 'User login', description: 'Authenticate user and get access tokens' })
